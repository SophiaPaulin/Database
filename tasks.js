...
db.company_drives.find({date:{$gt:new Date("2024-10-15"),$lt:new Date("2024-10-31")}})
...
db.usertask.find({date:{$gt:new Date("2024-10-15"),$lt:new Date("2024-10-31")}}).forEach(function(value){
    print("Name : "+value.user_name);
